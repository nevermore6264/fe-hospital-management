...
export function LoginForm({
  ...
  const [loadingAccountEmail, setLoadingAccountEmail] =
      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12">
          ...
          >
            ...
            >
              Nền tảng quản lý bệnh viện toàn diện với công nghệ
              tiên tiến, giúp tối ưu hóa quy trình chăm sóc bệnh
              nhân và quản lý y tế.
            </motion.p>
            ...
            >
              {[
                { icon: Users, number: "2,500+", label: "Bệnh nhân", color: "teal" },
                { icon: Stethoscope, number: "150+", label: "Bác sĩ", color: "blue" },
                { icon: Calendar, number: "98%", label: "Hiệu quả", color: "purple" },
                { icon: Clock, number: "24/7", label: "Hỗ trợ", color: "green" }
              ].map((stat, index) => (
                <motion.div 
                  key={index}
                ...
                >
                  <motion.div 
                    ...
                    whileHover={{ 
                      boxShadow: `0 0 20px rgba(${stat.color === 'teal' ? '45, 212, 191' : stat.color === 'blue' ? '59, 130, 246' : stat.color === 'purple' ? '168, 85, 247' : '34, 197, 94'}, 0.4)`
                    }}
                  >
                    <motion.div
                      animate={{ 
                          ...
                          >
                            ...
                            >
                              <motion.div
                                ...
                                animate={{ x: [-100, 100] }}
                                transition={{ duration: 2, repeat: Infinity, repeatDelay: 3 }}
                                style={{ display: isPopoverOpen ? 'none' : 'block' }}
                              />
                              <div className="flex items-center space-x-2 relative">
                                <motion.div 
                                  className="p-1 rounded-md transition-all duration-200 relative overflow-hidden"
                                  style={{
                                    background: loading ? 'linear-gradient(45deg, #6b7280, #9ca3af)' : 'linear-gradient(45deg, #3b82f6, #14b8a6)'
                                  }}
                                  whileHover={{ 
                                  ...
                                  transition={{ duration: 2, repeat: isPopoverOpen ? Infinity : 0 }}
                                >
                                  {loading ? (
                                    <motion.div 
                                      className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full"
                                  ...
                                  >
                                    ...
                                    <div className="flex flex-col items-center space-y-2 w-full relative">
                                      <motion.div
                                        ...
                                        whileHover={{ 
                                          scale: 1.1,
                                          boxShadow: `0 0 20px ${account.color.includes('red') ? 'rgba(239, 68, 68, 0.4)' : 
                                                                  account.color.includes('blue') ? 'rgba(59, 130, 246, 0.4)' :
                                                                  account.color.includes('green') ? 'rgba(34, 197, 94, 0.4)' :
                                                                  account.color.includes('purple') ? 'rgba(168, 85, 247, 0.4)' :
                                                                  account.color.includes('orange') ? 'rgba(249, 115, 22, 0.4)' :
                                                                  'rgba(107, 114, 128, 0.4)'}`
                                        }}
                                        animate={{  
                                          boxShadow: loadingAccountEmail === account.email ? 
                                            [`0 0 10px ${account.color.includes('red') ? 'rgba(239, 68, 68, 0.3)' : 
                                                        account.color.includes('blue') ? 'rgba(59, 130, 246, 0.3)' :
                                                        account.color.includes('green') ? 'rgba(34, 197, 94, 0.3)' :
                                                        account.color.includes('purple') ? 'rgba(168, 85, 247, 0.3)' :
                                                        account.color.includes('orange') ? 'rgba(249, 115, 22, 0.3)' :
                                                        'rgba(107, 114, 128, 0.3)'}`,
                                             `0 0 20px ${account.color.includes('red') ? 'rgba(239, 68, 68, 0.5)' : 
                                                        account.color.includes('blue') ? 'rgba(59, 130, 246, 0.5)' :
                                                        account.color.includes('green') ? 'rgba(34, 197, 94, 0.5)' :
                                                        account.color.includes('purple') ? 'rgba(168, 85, 247, 0.5)' :
                                                        account.color.includes('orange') ? 'rgba(249, 115, 22, 0.5)' :
                                        ...
                                        transition={{ duration: 1, repeat: loadingAccountEmail === account.email ? Infinity : 0 }}
                                      >
                                      ...
                                      <div className="text-center">
                                        <motion.div 
                                          ...
                                          animate={{ 
                                            scale: loadingAccountEmail === account.email ? [1, 1.05, 1] : 1
                                          }}
                                          transition={{ duration: 0.8, repeat: loadingAccountEmail === account.email ? Infinity : 0 }}
                                        >
                                          {account.role === "SUPERADMIN" ? "SUPER ADMIN" :
                                           account.role === "RECEPTIONIST" ? "LỄ TÂN" :
