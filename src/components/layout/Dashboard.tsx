    ...
    switch (user?.role) {
      case "DOCTOR":
        return [
          {
            time: "09:30",
            action: "Khám bệnh nhân Nguyễn Văn A",
            status: "completed",
          },
          {
            time: "10:15",
          ...
          {
            time: "14:30",
            action: "Lịch hẹn với Trần Thị B",
            status: "upcoming",
          },
        ];
      case "PATIENT":
        return [
          {
            time: "2 ngày trước",
            action: "Khám tại khoa Tim mạch",
            status: "completed",
          },
          {
            time: "1 tuần trước",
            action: "Làm xét nghiệm máu",
            status: "completed",
          },
          {
            time: "3 ngày tới",
            action: "Tái khám với BS. Trần Thị Hương",
            status: "upcoming",
          },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white/80 backdrop-blur-sm border-blue-200">
          <CardHeader>
            ...
            <CardDescription>Các hoạt động và sự kiện mới nhất</CardDescription>
          </CardHeader>
          <CardContent>
